        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPictureId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Ranks_RankId",
                        column: x => x.RankId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarAverage = table.Column<short>(type: "smallint", nullable: false),
                    TotalStarCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddress = table.Column<string>(type: "VARCHAR(35)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentWithoutUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentWithoutUsers_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentWithUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentWithUsers_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommentWithUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2021, 9, 24, 17, 12, 43, 506, DateTimeKind.Local).AddTicks(1790), true, false, null, null, "Admin" });

            migrationBuilder.InsertData(
                table: "OperationClaims",
                columns: new[] { "Id", "CreatedByUserId", "CreatedDate", "IsActive", "IsDeleted", "ModifiedByUserId", "ModifiedDate", "Name" },
                values: new object[] { 2, null, new DateTime(2021, 9, 24, 17, 12, 43, 511, DateTimeKind.Local).AddTicks(8860), true, false, null, null, "NormalUser" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_RankId",
                table: "Categories",
                column: "RankId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryAndArticles_ArticleId",
                table: "CategoryAndArticles",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentWithoutUsers_ArticleId",
                table: "CommentWithoutUsers",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentWithUsers_ArticleId",
                table: "CommentWithUsers",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentWithUsers_UserId",
                table: "CommentWithUsers",
                column: "UserId");
